...
{                                                                                    for ($i = 0; $i < count($list); $i++) {                                              if ($list[$i]->subscription == $name) {                                              return true;
        }
    }
    return false;
}
...
<html class="loading">
  <head>
    ...
    <title>Trainer Ash CHECKER</title>
    ...
    <div class="col-md-8">
      <div class="card">
        <div class="card-body text-center">
          <h4 class="mb-2"><strong> INSANE XD </strong></h4>
<h4 class="mb-2"><strong>INSANE XD</strong></h4>

          <textarea rows="12" class="form-control text-center form-checker mb-2" placeholder="PUT YOUR CARDS HERE"></textarea>
          
          <textarea rows="1"class="form-control text-center" style="width: 100%; float: right margin-bottom 5px;" id="cst" placeholder="ENTER YOUR USER ID FOR SENDING HITS :)"></textarea></br>
          <a href="https://t.me/NOBKT" class="btn btn-success btn-block" style="margin-bottom: 10px;">HIT SENDER BOT</a>


                    <select name="gate" id="gate" class="form-control" style="margin-bottom: 5px;"
    <option </option>
             <option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="nigga/nogate.php">Select Gateway</option>
              <option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="nigga/PayPal.php">PayPal 0.1$</option>
        <option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="nigga/stripe_10€.php">Stripe 10€</option>
-->
</select>
  <br>                    
...
<h5>DEAD :<span class="badge badge-danger float-right reprovadas">0</span></h5><hr>
      ...
      <div class="card">
        <div class="card-body">
          ...
          <h4 class="card-title mb-1"><i class="fa fa-check-circle text-success"></i> HIT</h4>          
...
<footer>
  <p>created by <a href="https://t.me/newashv1">@newashv1</a></p>
</footer>
<script>
...
function RedirectUrl(){    
       window.location.href ="https://t.me/Ashyep";
    }
